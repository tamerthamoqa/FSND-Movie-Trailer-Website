...
def ready_movies():
    ...
    Returns:
     ...
     """
    troy = media.Movie(movie_title="Troy",
    ...
    kingdom_of_heaven = media.Movie(movie_title="Kingdom of Heaven",
    ...
    warrior = media.Movie(movie_title="Warrior",
    ...
    pulp_fiction = media.Movie(movie_title="Pulp Fiction",
    ...
    the_dark_knight = media.Movie(movie_title="The Dark Knight",
                                  poster_image="https://upload.wikimedia.org/wikipedia/en/8/8a/Dark_Knight.jpg",
                                  trailer_youtube="https://www.youtube.com/watch?v=vKQi3bBA1y8" )

    whiplash = media.Movie(movie_title="Whiplash",
    ...
    dredd = media.Movie(movie_title="Dredd",
    ...
    ai_artificial_intelligence = media.Movie(movie_title="A.I. Artificial Intelligence",
    ...
    watchmen = media.Movie(movie_title="Watchmen",
    ...
    the_rock = media.Movie(movie_title="The Rock",
